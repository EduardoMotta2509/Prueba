	...
	public static void main(String[] args) { 
		...
		button.addActionListener(new ActionListener() { 
			...
			public void actionPerformed(ActionEvent e) {
				boolean confirmarCambios = true;
				
				try { 
					int edad = Integer.parseInt(edadField.getText());
					if(edad<18 || edad>100) {
						JOptionPane.showMessageDialog(frame, "Por favor, ingrese un número entre 1 y 100 para la edad."); 
				...
				if(confirmarCambios == true) {
					...
					JOptionPane.showMessageDialog(frame, "No se actualizaron los cambios");
				}
			} 
		});
