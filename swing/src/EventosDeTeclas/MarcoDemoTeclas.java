...
public class MarcoDemoTeclas extends JFrame implements KeyListener{
	...
	private String linea2 = ""; //segunda linea del area de texto
	private String linea3 = ""; //tercera linea del área de texto
	private JTextArea areaTexto; //Area de texto para mostrar la salida
	
	//constructor de MArcoDemoTeclas
	public MarcoDemoTeclas() {
		super("Demostracion de los eventos de pulsacion de teclas - Eduardo Motta");
	...
	public void keyPressed(KeyEvent evento) {
		...
		establecerLineas2y3(evento); //establece las lineas de salida dos y tres
	}
	...
	//establece las lineas de salida dos y tres
	private void establecerLineas2y3(KeyEvent evento) {
		...
		areaTexto.setText(String.format("%s\n%s\n%s\n", linea1, linea2, linea3)); //imprime tres lineas de texto
	}
